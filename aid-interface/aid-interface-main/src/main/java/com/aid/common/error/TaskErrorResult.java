...
public class TaskErrorResult {
    ...
    /**
     * 从枚举 + 原始错误信息构建结果。
     * 默认 taskStatus=FAILED, billingStatus=null, refundStatus=NONE（错误码不掌握资金流向，
     * 退款状态须由调用方按 billingStatus 经 {@link RefundStatusMapper} 派生后覆盖）。
     */
    public static TaskErrorResult of(TaskErrorCode code, String rawMessage) {
        return TaskErrorResult.builder()
                ...
                .refundStatus(RefundStatusMapper.NONE)
                .build();
    }

...
public class StoryboardVO {
    ...
    /** 推荐视频时长来源：STORYBOARD_SUGGESTION=分镜建议，MODEL_DEFAULT=模式默认模型。 */
    private String recommendedDurationSource;

    /** 推荐视频时长说明，供前端展示及切换模型时处理档位。 */
    private String recommendedDurationDescription;

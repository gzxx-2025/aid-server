 ...
 * Seedream 图片 / Seedance 视频走 Ark Java SDK 提交，无法直接发「空体 HTTP」。
 * 因此用固定的 {@code /api/v3/chat/completions} 端点发空体做密钥+网关探活：
...
public class VolcengineProbe extends AbstractRestSubmitProbe {
    ...
    private static final String ARK_CHAT_COMPLETIONS = "/api/v3/chat/completions";

...
public class CreationStepServiceImpl implements ICreationStepService {
    ...
    /**
     * 剧集-步骤1：项目配置 —— 画面比例、剧本类型、视频风格来源均已填写。
     */
    ...
    /**
     * 剧集-步骤2：剧本创作 —— 至少有一条剧本且原文非空（按当前用户隔离）。
     */
    ...
    /**
     * 剧集-步骤5：视频生成 —— 总数>0（不校验是否已选定视频，按当前用户隔离）。
     */
    ...
    /**
     * 剧集-步骤6：音画同步 —— 总数>0（不校验是否已选定配音，按当前用户隔离）。
     */
    ...
    /**
     * 电影-步骤1：项目配置 —— 画面比例、剧本类型、视频风格来源均已填写。
     */
    ...
    /**
     * 电影-步骤2：剧本创作 —— 至少有一条剧本且原文非空（按当前用户隔离）。
     */
    ...
    /**
     * 电影-步骤3：素材准备 —— 至少包含1个角色和1个场景（主表，episodeId=0，按当前用户隔离）。
     */
    ...
    /**
     * 电影-步骤5：视频生成 —— 总数>0（不校验是否已选定视频，按当前用户隔离）。
     */
    ...
    /**
     * 电影-步骤6：音画同步 —— 总数>0（不校验是否已选定配音，按当前用户隔离）。
     */

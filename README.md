...
AID 的初始化数据会引用一组官方媒体资源，用于首次部署后的平台展示和创作示例，包括角色、场景、道具、光影、景别/焦距、姿态、表情、特效、分镜示例、智能体与供应商图标、语音头像与 MP3 试听、首页图片及演示视频。为方便完全离线或私有化部署，同版本发布页会同时提供 `aid-official-assets_<版本>.tar.gz`。
...
- 下载入口：[GitHub Releases（主要制品源）](https://github.com/gzxx-2025/aid-server/releases) · [Gitee Releases（版本入口）](https://gitee.com/gzxx-2025/aid-server/releases)。请选择与程序版本一致的资产包，具体导入命令见包内 `README.md`。
